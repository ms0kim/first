const cursorModule = () => {
  ...
  const initCursorHovers = () => {
    const handleCanvasCursorMouseEnter = e => {
      ...
      isStuck = true;
      TweenMax.to(innerCursor, 1, {background:'#b8ad9e', scale:0.25, ease: Expo.easeOut});
    };
    const handleCanvasCursorMouseLeave = () => {
      isStuck = false;
      TweenMax.to(innerCursor, 1, {background:'#EDDFCD', scale:1, ease: Expo.easeOut});
    };
    const handleBasicCursorMouseEnter = e => {
      TweenMax.to(innerCursor, 1, {background:'#b8ad9e', scale:4, ease: Expo.easeOut});
    };
